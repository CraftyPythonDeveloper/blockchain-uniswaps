...
def main():
    ...
    json_rpc_url = "https://rpc.ankr.com/eth"
    ...
    # Get contracts
    Factory = get_contract(web3, r"C:\Users\Anon\Downloads\UniswapV2Factory.json")
    Pair = get_contract(web3, r"C:\Users\Anon\Downloads\UniswapV2Pair.json")
    ...
    pairs_fname = "uni-v2-pairs.csv"
    swaps_fname = "uni-v2-swaps.csv"
